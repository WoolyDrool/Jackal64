...
namespace Project.Runtime.Gameplay.Tools
{
    public class ToolTrashPicker : EquippableObject
    {
        ...
        private RangerInventory _inventory;
        #endregion
        
        void Start()
        {
            _playerCamera = GameManager.instance.cameraManager.cameraComponent.transform;
